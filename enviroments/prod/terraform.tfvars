...
stg = {
  "stg1" = {
    name                     = "prodstg00010"
    resource_group_name      = "rg-sandeep-001"
    location                 = "west us"
...
vnets = {
  ...
  "vnet2" = {
    vnet_name           = "VNet002"
    location            = "central india"
    resource_group_name = "rg-sandeep-002"
    address_space       = ["10.0.0.0/16"]
    nsg_name            = "raw-01"
    security_rule = {
      rule1 = {
...
vms = {
  vm1 = {
    ...
    key_vault_name      = "sandeepkeyvault000001"
...
sql_databases = {
  db1 = {
    ...
    max_size_gb         = 2
    enclave_type        = "VBS"
    server_name         = "mssqlserver-todo007"
    resource_group_name = "rg-sandeep-001"
